...
public class DiscountRecycleAdapter extends RecyclerView.Adapter<DiscountRecycleAdapter.DiscountsViewHolder> {
    ...
    public DiscountRecycleAdapter(List<Discounts> listDiscounts, Context context) {
        ...
        public DiscountsViewHolder(View view) {
            ...
            moredetails_button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    String client = listDiscounts.get(getPosition()).getClientName();
                    String code = listDiscounts.get(getPosition()).getDiscountCode();
                    // set dialog title
